 ...
 */
package com.gu.tiny.common.aspect;

import com.gu.tiny.common.utils.RequestHolder;
import com.gu.tiny.common.utils.StringUtils;
import com.gu.tiny.common.utils.ThrowableUtil;
...
public class LogAspect {
     ...
     * 配置切入点
     */
    @Pointcut("@annotation(com.gu.tiny.common.annotation.Log)")
    ...
    public void logAfterThrowing(JoinPoint joinPoint, Throwable e) {
        UmsLog log = new UmsLog("ERROR", System.currentTimeMillis() - currentTime.get());
        currentTime.remove();
